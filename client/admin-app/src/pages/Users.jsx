...
//   const systemAdminEmail = import.meta.env.ADMIN_EMAIL;
...
//   async function handleDelete(id, emailAddr) {
//     if (!window.confirm(`Delete user "${emailAddr}"? This cannot be undone.`)) return;
//     try {
//       await API.delete(`/admin/users/${id}`);
//       setUsers((prev) => prev.filter((u) => u.id !== id));
//     } catch (err) {
...
//         email,
//         password,
//         role, // already uppercase (USER/ADMIN)
//       });
//       // reset form
//       setName("");
//       setEmail("");
...
//       <form
//         onSubmit={addUser}
//         className="bg-white shadow rounded-lg p-4 flex flex-wrap gap-3 items-end"
//       >
//         <div className="flex flex-col">
