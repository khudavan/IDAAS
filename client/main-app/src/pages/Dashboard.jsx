...
//       label: "Alerts",
//       value: stats?.alerts,
//       icon: <Notifications fontSize="large" color="error" />,
//       color: "linear-gradient(135deg, #ff6a00, #ee0979)",
//     },
//     {
//       label: "Last Login",
...
//         ? new Date(stats.lastLogin).toLocaleString()
//         : "—",
//       icon: <BarChart fontSize="large" color="success" />,
//       color: "linear-gradient(135deg, #43e97b, #38f9d7)",
//     },
//   ];
...
//     async function load() {
//       try {
//         const { data } = await API.get("/main/dashboard"); // protected + permission
//         setStats(data?.stats || null);
//       } catch {
//         setErr("Access denied or session expired.");
//       } finally {
...
//               <Typography variant="body1">{new Date(stats.lastLogin).toLocaleString()}</Typography>
//             </CardContent></Card>
//           </Grid>
//         </Grid>
//       )}
